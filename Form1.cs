...
namespace FlappyBird
    //Создаем значения графических виджетов
{
    public partial class Form1 : Form
    {
        ...
        // объявляем параметры игрока, труб
        public void Init()
        {
        ...
        //задаем физческие способности для птицы
        ...
        //прописывание режима прохождения уровнейц
        ...
        //Если пролетели трубу, открывается след трубы=уровни
